...
class MassCalculator(QtWidgets.QWidget):
    def __init__(self):
        super().__init__()
        ...
        self.combo1.addItems(Mass_measurements)
        ...
        self.combo2.addItems(Mass_measurements)
    ...
    def PintUnit(self, unit_name):
        units = {
            ...
            "Grams": self.u.g,
            "Kilograms": self.u.kg,
            "Milligrams": self.u.mg,
            "Centigrams": self.u.cg,
            "Decigrams": self.u.dg,
            "Hectograms": self.u.hg,
            "Grains": self.u.gr,
            "Pounds": self.u.lb,
            "Ounces": self.u.oz,
            "Stone": self.u.stone,
            "Metric Tonnes": self.u.t,
            "Short Tons (US)": self.u.short_ton,
            "Long Tons (UK)": self.u.long_ton,
            "Pennyweight": self.u.dwt,
        }
    ...
    def unitDisplayName(self, unit_name):
        names = {
            ...
            "Stone": "stone",
            "Metric Tonnes": "t",
            "Short Tons (US)": "short ton (US)",
            "Long Tons (UK)": "long ton (UK)",
            "Pennyweight": "dwt",
        }
