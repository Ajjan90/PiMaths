...
class EnergyCalculator(QtWidgets.QWidget):
    ...
    def PintUnit(self, unit_name):
        units = {
            "Joules": self.u.joule,
            "Kilojoules": self.u.kilojoule,
            "Megajoules": self.u.megajoule,
            "Gigajoules": self.u.gigajoule,
            "Terajoules": self.u.terajoule,
            "Petajoules": self.u.petajoule,
            "Exajoules": self.u.exajoule,
            "Millijoules": self.u.millijoule,
            "Microjoules": self.u.microjoule,
            "Nanojoules": self.u.nanojoule,
            "Ergs": self.u.erg,
            "WattHours": self.u.watt_hour,
            "KilowattHours": self.u.kilowatt_hour,
            "MegawattHours": self.u.megawatt_hour,
            "GigawattHours": self.u.gigawatt_hour,
            "TerawattHours": self.u.terawatt_hour,
            "PetawattHours": self.u.petawatt_hour,
            "Calories": self.u.calorie,
            "Kilocalories": self.u.kilocalorie,
            "British thermal unit (BTUs)": self.u.BTU,
            "Therms": self.u.therm,
            "Quads": self.u.quad,
            "FootPounds": self.u.foot_pound,
            "Electronvolts": self.u.eV,
            "Kiloelectronvolts": self.u.keV,
            "Megaelectronvolts": self.u.MeV,
            "Gigaelectronvolts": self.u.GeV,
            "Teraelectronvolts": self.u.TeV,
            "Petaelectronvolts": self.u.PeV,
            "Exaelectronvolts": self.u.EeV,
            "Hartrees": self.u.hartree,
            "Rydbergs": self.u.rydberg,
        }
