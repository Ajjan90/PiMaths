...
class LengthCalculator(QtWidgets.QWidget):
    def __init__(self):
        super().__init__()
        ...
        self.combo1.addItems(Len_measurements)
        ...
        self.combo2.addItems(Len_measurements)
    ...
    def PintUnit(self, unit_name):
        units = {
            ...
            "Inches": self.u.inch,
            "Metres": self.u.m,
            "Centimetres": self.u.cm,
            "Millimetres": self.u.mm,
            "Micrometres": self.u.μm,
            "Nanometres": self.u.nm,
            "Kilometres": self.u.km,
            "Miles": self.u.mi,
            "Yards": self.u.yd,
            "Megametres": self.u.Mm,
            "Picametres": self.u.pm,
        }
